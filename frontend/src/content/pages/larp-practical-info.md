...
practicalInfoImage: src/images/uploads/info_toiky.png
practicalInfoBody: >-
  Ak si nováčik, ktorý ide na svoj prvý LARP, je normálne, ak nevieš, ako to bude vyzerať. Pokúsime sa ti zodpovedať všetky otázky, ktoré si možno kladieš. 

  ### Pred hrou na lokačke 

  Dorazíš v priebehu stredy autom alebo **autobusom 555** na zastávku **Častá, Červený Kameň**. Uvidíš lúku, kde si môžeš postaviť svoj moderný stan. Ak prichádzaš autom, **neparkuj** pri organizátorskom hangári - tieto parkovacie miesta sú vyhradené pre organizačný tím.

  
  Pri stavaní stanu si vyber voľné miesto v rade. Dbaj na to, aby šnúrky z tvojho stanu **nezasahovali do vyznačenej cestičky** - v noci po nej budú chodiť ľudia, ktorí by o ne mohli zakopnúť.
